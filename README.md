...
7. Project is operational. API post request to ht<span>tps://</span>a1l45&lt;resourceGroupName&gt;.azure-api.net/function/ with test data in the body will success after enough time to collect some data, train and initially deploy the first version of a model (around 70 minutes).
